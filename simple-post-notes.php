...
class SPNotes {
	...
	public function load_textdomain() {
		...
		load_plugin_textdomain( 'spnotes', false, dirname( plugin_basename( __FILE__ ) ) . '/langs/' );
	...
	public function metabox( $post ) {
		...
		echo '<textarea style="display: block; width: 100%;" rows="5" name="spnote" />' . esc_attr( $note ) . '</textarea>';
	...
	?>
		...
		<div class="wrap">
			...
			<h2><?php _e( 'Simple Post Notes Settings', 'spnotes' ); ?></h2>
	...
	public function settings_post_type_field() {
		...
		echo '<p class="description">'.__( 'Apply Post Notes to these post types', 'spnotes' ).'</p>';
